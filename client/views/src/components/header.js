          ...
          <div className="cearfix">
            <ul className="dropdown-btn d-inline-block float-left">
              ...
              <ul className="dropdown">
                <li><b style={{ fontSize: 20, fontWeight: 900 }}>Popular Stores</b></li>
                <li> hello </li>
                <li> hello </li>
                <li> hello </li>
                <li> hello </li>
            ...
            <Link className="search d-inline-block float-left" to={'/skills'}>
            ...
            <h3 className="d-inline money">
              <Link className="" style={{fontWeight: 900}} to={'/'}>#SHIT<span></span></Link>
            </h3>
